...
export default function Sidebar({ current, onNavigate }: Props) {
  return (
    <>
      <aside className="hidden md:flex w-64 shrink-0 bg-white border-r border-slate-100 flex-col min-h-screen">
        {/* Logo */}
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-slate-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
